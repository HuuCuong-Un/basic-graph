...
//    }
    ...
    //LOAD FROM DATABASE
        //FILE DATABASE ALREADY IN FILE NAME Data.sql
    public static void LoadDatabase() {
        ...
        try {
            ...
            System.out.println("LOADING FROM DATABASE: GRAPH_PROJECT");
            System.out.println("");
            // =======================================
            try {
...
//                      set matrix row and column size                                                           |return the data at specific position in list
    ...
    //-----------------------------------------------------------------------------------------------------
    //=========================================Convert1=====================================================
    static void Convert1() { //FROM ADJACENCY MATRIX TO INCIDENT MATRIX
        adjMatrixToIncMatrix(getVertex, edgeList);
    }
    ...
    //-----------------------------------------------------------------------------------------------------
    //=========================================Convert2=====================================================
    static void Convert2() { //FROM ADJACENCY MATRIX TO ADJACENCY LIST
        adjMatrixToList(getVertex, edgeList);
    ...
    public static void BFS(String s) {
       ...
       LinkedList<Vertex<String>> queue = new LinkedList<>();
        ...
        for (Vertex<String> vertexInList : getVertex) {
            if (vertexInList.getData().equals(s)) {
...
//        }
        ...
        System.out.println("Given an Adjacency Matrix:");
        ...
        System.out.println("====================INCIDENT MATRIX======================");
        System.out.println("");
        ...
        Dijkstra<String> dijkstra = new Dijkstra<>(getVertex);
        dijkstra.Findpath("Q", "A");
        ...
        System.out.println("");
        Prim p = new Prim(createListOfEdgeOneDirect(adjacencyMatrix, getVertex), getVertex);
        p.MST1("B");
        System.out.println("");
        ...
        new Kruskal<>(edgeList).MST2();

        System.out.println("");
        
        
        System.out.println("========================EULER=============================");
        System.out.println("Founding is this graph has euler circuit..");
